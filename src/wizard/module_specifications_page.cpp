...
const QString S_AUTO_COMPLETE_LABEL =
        QStringLiteral("autocomplete description");
...
ModuleSpecificationsPage::autoComplete()
{
    ...
    m_fileNameEdit->setText(settings()->fileNamingScheme(moduleName, prefix));
    m_classNameEdit->setText(settings()->classNamingScheme(moduleName, prefix));
