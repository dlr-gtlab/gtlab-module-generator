...
const QString
ModuleSpecificationsPage::S_AUTO_GENERATED_ALT_TOOLTIP =
    ...
    AbstractWizardPage(settings, parent)
{
    ...
    auto* vSpacer = new QSpacerItem(1, 1000, QSizePolicy::Minimum,
    ...
    baseLayout->addWidget(infoTextLabel, 0, 0, 1, 2);
    baseLayout->addWidget(modulePrefixLabel, 1, 0);
    baseLayout->addWidget(m_modulePrefixEdit, 1, 1);
    baseLayout->addWidget(moduleNameLabel, 2, 0);
    baseLayout->addWidget(m_moduleNameEdit, 2, 1);
    baseLayout->addWidget(classNameLabel, 3, 0);
    baseLayout->addWidget(m_classNameEdit, 3, 1);
    baseLayout->addWidget(fileNameLabel, 4, 0);
    baseLayout->addWidget(m_fileNameEdit, 4, 1);
    baseLayout->addWidget(versionLabel, 5, 0);
    baseLayout->addWidget(m_versionEdit, 5, 1);
    baseLayout->addWidget(descriptionLabel, 6, 0);
    baseLayout->addWidget(m_descriptionEdit, 6, 1);
    baseLayout->addWidget(m_autoEditCheckBox, 7, 0, 1, 2);
    baseLayout->addItem(vSpacer, 8, 0, 1, 2);
