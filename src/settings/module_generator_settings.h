...
public:
    ...
    // dependencies
    inline DependencyStructs selectedDependencies() const { return m_selectedDependencies; }
    inline void setSelectedDependencies(const DependencyStructs& dependencies) { m_selectedDependencies = dependencies; }
